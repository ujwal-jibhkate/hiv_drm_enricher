...
# These are the NEW, gene-relative coordinates for your pol_gene_HIV1_sequence.fasta
GENE_COORDINATES = {
    "PR": {"start": 1, "end": 297},       # Protease is the first 297 bases (99 codons)
    "RT": {"start": 298, "end": 1977}     # RT (560 codons) starts right after PR
}
